  ...
  Future<sqflite.Database> open(String path, List<Migration> migrations,
    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        ...
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `food_extras` (`id` INTEGER, `productId` INTEGER, `price` REAL, `name` TEXT, `photo` TEXT, PRIMARY KEY (`id`))');
        await database.execute(
        ...
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `vendors` (`id` INTEGER, `name` TEXT, `slug` TEXT, `address` TEXT, `latitude` TEXT, `longitude` TEXT, `featureImage` TEXT, `logo` TEXT, `rating` REAL, `minimumOrder` REAL, `deliveryFee` REAL, `deliveryRange` REAL, `cuisines` TEXT, `minimumDeliveryTime` INTEGER, `maxmumDeliveryTime` INTEGER, PRIMARY KEY (`id`))');
        await database.execute(
...
class _$ProductDao extends ProductDao {
  ...
  @override
  Future<List<Product>> findAllFoods() async {
...
class _$ProductExtraDao extends ProductExtraDao {
  ...
  static final _food_extrasMapper = (Map<String, dynamic> row) => ProductExtra(
      id: row['id'] as int,
